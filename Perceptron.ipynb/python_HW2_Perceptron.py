...
# 
# <p><strong>Project Notes:</strong> The due date is <strong>11:59 pm EST on February 22nd</strong>. Late submissions are accepted and the late due date is <strong>11:59 pm EST on February 24th</strong>. Submissions beyond the late due date will not be recorded.
# 
...
# 
# <p><strong>Getting Help:</strong> You are not alone!  If you find yourself stuck  on something, contact the course staff for help.  Office hours, section, and the <a href="https://edstem.org/us/courses/54233/">Ed Discussion</a> are there for your support; please use them.  We want these projects to be rewarding and instructional, not frustrating and demoralizing.  But, we don't know when or how to help unless you ask.
# 
...
def perceptron(xs,ys,max_iter=100):
    ...
    while t <= max_iter:
        ...
        ys = ys[idx]
        for i in range(n):
            if ((np.dot(w,xs[i])*ys[i]) <= 0): ## if row i is misclassified
